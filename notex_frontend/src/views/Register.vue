...
const validateForm = (): boolean => {
  ...
  } else if (formData.value.nickname.length < 1 || formData.value.nickname.length > 50) {
    errors.value.nickname = '昵称长度必须在1-50之间'
  }
    ...
    <div class="flex items-center justify-center min-h-screen p-8">
      <div class="w-full max-w-md">
        <div class="text-center mb-8">
          ...
          <p class="text-gray-600 dark:text-gray-400">创建新账户</p>
        </div>
        ...
        <div class="mt-6 text-center space-y-2">
          <router-link to="/login" class="block text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
            已有账户？去登录
          </router-link>
